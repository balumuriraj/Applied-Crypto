...
public class CertOps {
	...
	public void printCert() throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException, UnrecoverableEntryException, InvalidKeyException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException
	{
		...
		System.out.println("------------------------------Verify Raghus certificate--------------------------");
		System.out.println();
		System.out.println("1. Print the certificate");
		System.out.println("-------------------------------------------------------------------------");
		try {
			raghupubcert.verify(CApubkey);
			System.out.println("Verified Raghus Certificate!");
		} catch (InvalidKeyException | NoSuchProviderException
				| SignatureException e) {
			// TODO Auto-generated catch block
			System.out.println("Error while verifying Raghus Certificate!");
		}
		System.out.println(raghupubcert);

		System.out.println("\n2. Print Raghus public and private key");
		System.out.println("-------------------------------------------------------------------------");
		System.out.println("Raghus Public Key is: ");
		...
		System.out.println("-------------------------------------------------------------------------");
		System.out.println("Certification Authoritys Public Key is: ");
		...
		System.out.println("\n4. Print the signature on TAs certificate.");
		System.out.println("-------------------------------------------------------------------------");
		System.out.println("Signature on TAs certificate: ");
